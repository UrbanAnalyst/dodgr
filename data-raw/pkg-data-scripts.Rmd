...
maxspeeds:
```{r}
w <- weighting_profiles
w$speeds <- NA
w$speeds [w$name == "bicycle"] <- 15
w$speeds [w$name == "bicycle" & w$way == "primary"] <- 7.5
w$speeds [w$name == "bicycle" & w$way == "secondary"] <- 12
w$speeds [w$name == "bicycle" & w$way == "tertiary"] <- 12
w$speeds [w$name == "bicycle" & w$way == "primary_link"] <- 7.5
w$speeds [w$name == "bicycle" & w$way == "secondary_link"] <- 9.75
w$speeds [w$name == "bicycle" & w$way == "tertiary_link"] <- 12
w$speeds [w$name == "bicycle" & w$way == "track"] <- 12
w$speeds [w$name == "bicycle" & w$way == "path"] <- 12

w$speeds [w$name == "foot"] <- 5

w$speeds [w$name == "wheelchair"] <- 5

w$speeds [w$name == "horse"] <- 6.4

w$speeds [w$name == "motorcar"] <- 36
w$speeds [w$name == "motorcar" & w$way == "motorway"] <- 90
w$speeds [w$name == "motorcar" & w$way == "motorway_link"] <- 45
w$speeds [w$name == "motorcar" & w$way == "trunk"] <- 85
w$speeds [w$name == "motorcar" & w$way == "trunk_link"] <- 40
w$speeds [w$name == "motorcar" & w$way == "primary"] <- 65
w$speeds [w$name == "motorcar" & w$way == "primary_link"] <- 30
w$speeds [w$name == "motorcar" & w$way == "secondary"] <- 55
w$speeds [w$name == "motorcar" & w$way == "secondary_link"] <- 25
w$speeds [w$name == "motorcar" & w$way == "tertiary"] <- 40
w$speeds [w$name == "motorcar" & w$way == "tertiary_link"] <- 20
w$speeds [w$name == "motorcar" & w$way == "unclassified"] <- 25
w$speeds [w$name == "motorcar" & w$way == "residential"] <- 25
w$speeds [w$name == "motorcar" & w$way == "living_street"] <- 10
w$speeds [w$name == "motorcar" & w$way == "service"] <- 15

# Then just repeat those for all other motorized modes:
w$speeds [w$name == "motorcycle"] <- w$speeds [w$name == "motorcar"]
w$speeds [w$name == "goods"] <- w$speeds [w$name == "motorcar"]
w$speeds [w$name == "hgv"] <- w$speeds [w$name == "motorcar"]
w$speeds [w$name == "psv"] <- w$speeds [w$name == "motorcar"]

w$speeds [w$name == "moped"] <- 50
w$speeds [w$name == "moped" & w$way == "motorway"] <- 50
w$speeds [w$name == "motorcar" & w$way == "motorway_link"] <- 50
w$speeds [w$name == "motorcar" & w$way == "trunk"] <- 50
w$speeds [w$name == "motorcar" & w$way == "trunk_link"] <- 40
w$speeds [w$name == "motorcar" & w$way == "primary"] <- 50
w$speeds [w$name == "motorcar" & w$way == "primary_link"] <- 30
w$speeds [w$name == "motorcar" & w$way == "secondary"] <- 50
w$speeds [w$name == "motorcar" & w$way == "secondary_link"] <- 25
w$speeds [w$name == "motorcar" & w$way == "tertiary"] <- 40
w$speeds [w$name == "motorcar" & w$way == "tertiary_link"] <- 20
w$speeds [w$name == "motorcar" & w$way == "unclassified"] <- 25
...
weighting_profiles <- w
```

surface speeds:
```{r}
s <- rbind (c ("bike", "surface", "asphalt", 15), # default speed
            c ("bike", "cobblestone", "flattened", 10),
            c ("bike", "surface", "paving_stones", 10),
            c ("bike", "surface", "compacted", 10),
            c ("bike", "surface", "cobblestone", 6),
            c ("bike", "surface", "unpaved", 6),
            c ("bike", "surface", "fine_gravel", 6),
            c ("bike", "surface", "gravel", 6),
            c ("bike", "surface", "pebblestone", 6),
            c ("bike", "surface", "ground", 6),
            c ("bike", "surface", "dirt", 6),
            c ("bike", "surface", "earth", 6),
            c ("bike", "surface", "grass", 6),
            c ("bike", "surface", "mud", 3),
            c ("bike", "surface", "sand", 3),
            c ("bike", "surface", "sett", 10),

            c ("walk", "surface", "fine_gravel", 3.75),
            c ("walk", "surface", "gravel", 3.75),
            c ("walk", "surface", "pebblestone", 3.75),
            c ("walk", "surface", "mud", 2.5),
            c ("walk", "surface", "sand", 2.5))
