...
surface speeds:
```{r}
s <- rbind (c ("bicycle", "surface", "asphalt", 15), # default speed
            c ("bicycle", "cobblestone", "flattened", 10),
            ...
            c ("foot", "surface", "fine_gravel", 3.75),
            c ("foot", "surface", "gravel", 3.75),
            c ("foot", "surface", "pebblestone", 3.75),
            c ("foot", "surface", "mud", 2.5),
            c ("foot", "surface", "sand", 2.5))
