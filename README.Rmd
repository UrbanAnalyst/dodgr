...
time-based routing](https://atfutures.github.io/dodgr/articles/times.html) for
more detail.
...
largest component; `2` the second largest; and so on). Note that all spatial
data are assumed to be in the EPSG:4326 (WGS84) coordinate system.
