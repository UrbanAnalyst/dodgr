 ...
 */
void BHeap::insert(int item, float key)
{
    /* i - insertion point
     * j - parent of i
 ...
 */
void BHeap::decreaseKey(int item, float newKey)
{
    const int n = itemCount;
