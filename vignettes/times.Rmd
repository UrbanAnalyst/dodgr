...
2. `turn_angle`, specifying whether edge times should include delays associated
   with turning across oncoming traffic.
...
graph (that is, one generated with `turn_angle = FALSE`), and then to modify
