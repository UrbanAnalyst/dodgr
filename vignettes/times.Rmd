...
```{r fig1, fig.align="center", echo=FALSE, engine='tikz',fig.ext='svg', code=readLines("times-fig1.tex"), fig.cap="Figure 1: Graph modification to account for turn penalties, which introduces the additional dashed lines representing compound edges with time penalties for turning penalties."}
```
