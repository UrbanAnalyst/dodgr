...
## 7.1 `dodgr_flows_aggregate()`

The former of these aggregates ''flows'' throughout a
...
of densities disersing from all origin (`from`) points. This is illustrated in
