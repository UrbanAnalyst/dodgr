...
```
This `graph` object returned from `weight_streetnet()` also includes a
...
case containing 182,420 edges, representing 97.4% of the graph. These component
numbers can also be used to ensure routing calculations consider only connected
vertices, as described below (under Distance Matrices).

Note also that the actual graph contains around 10 times as many edges as there are
