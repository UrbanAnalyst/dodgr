...
vignette](https://cran.r-project.org/web/packages/dodgr/vignettes/dodgr.html).)
...
[`osmplotr`](https://ropensci.github.io/osmplotr) can be used to visualise this
...
The final major functions of `dodgr` are
...
[`merge_directed_flows()`](https://atfutures.github.io/dodgr/reference/merge_directed_flows.html)
