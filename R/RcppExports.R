...
#'
#' @noRd
rcpp_flows_disperse <- function(graph, vert_map_in, fromi, k, flows, tol, heap_type) {
    .Call(`_dodgr_rcpp_flows_disperse`, graph, vert_map_in, fromi, k, flows, tol, heap_type)
}
