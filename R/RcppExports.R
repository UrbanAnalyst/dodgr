...
#'
#' @noRd
rcpp_flows_si <- function(graph, vert_map_in, fromi, toi_in, kvec, nvec, tol, dirtxt, heap_type) {
    invisible(.Call(`_dodgr_rcpp_flows_si`, graph, vert_map_in, fromi, toi_in, kvec, nvec, tol, dirtxt, heap_type))
}
